...
function addNode(type){
  ...
  if(type==='extractor'){node.description='Extract data from uploaded file';node.extract_prompt='Extract key information from this file';}
